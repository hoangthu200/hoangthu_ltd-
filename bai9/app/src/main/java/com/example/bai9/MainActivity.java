...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Võ Thị Hoàng Thu");
        ...
        arr_bean.add(new ListViewBean(R.drawable.ic_android, "Java",""));
        arr_bean.add(new ListViewBean(R.drawable.ic_android,"Python",""));
        arr_bean.add(new ListViewBean(R.drawable.ic_android, "MySQL",""));
        arr_bean.add(new ListViewBean(R.drawable.ic_android, "PHP",""));
