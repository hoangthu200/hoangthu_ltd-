...
<div class="panel panel-primary">
      <div class="panel-heading">Thời Trang Nam</div>
...
<?php
	...
	$page=$page-1;
	$limit= 12;
	$sql="select * from san_pham where loaisp like 'aoquannam'";
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="product">
		<?php
	$sl= "select * from san_pham where loaisp like 'aoquannam' limit ".$start.",".$limit;
			  ...
			  <ul class="pagination">
			    <?php 
			    	if($page==0){ 
			    		$page=$page+2;
			    		$prev="";
			    		$next= '<a href="?menu=aoquannam&page='.$page.'" aria-label="Next">
			        <span class="fa fa-step-forward"></span>
			      </a>';
			      		$firstpage="";
			      		$endpage= '<a href="?menu=aoquannam&page='.$total.'" aria-label="Final">
			        <span class="fa fa-fast-forward"></span>
			      </a>';
			    	}else if($page>=1){
			    		if($page==$total-1){
			    			$prpage= $page;
			    			$firstpage='<a href="?menu=aoquannam&page=1" aria-label="First">
			        <span class="fa fa-fast-backward"></span>
			      </a>';
			    			$endpage="";
			    			$prev='<a href="?menu=aoquannam&page='.$prpage.'" aria-label="Next">
			        ...
			        <span class="fa fa-step-forward"></span>			        
			      		...
			      		$firstpage='<a href="?menu=maoquannam&page=1" aria-label="First">
			        <span class="fa fa-fast-backward"></span>
			      </a>';
			      		$endpage= '<a href="?menu=aoquannam&page='.$total.'" aria-label="Final">
			        <span class="fa fa-fast-forward"></span>
