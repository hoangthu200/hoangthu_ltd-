...
<div class="product">
	...
	<?php
	include('connect.php');
	$sl= 'select * from san_pham where loaisp="aoquannu" limit 6';
...
<div class="product">
	...
	<?php
	include('connect.php');
	$sl= 'select * from san_pham where loaisp="aoquannam" limit 6';
	$exec= mysqli_query($connect, $sl);
	while($row= mysqli_fetch_array($exec)){
?>
	<div class="sp img-thumbnail col-xs-12 col-sm-6 col-md-6 col-lg-3">
...
<div class="product">
	...
	<?php
	include('connect.php');
	$sl= 'select * from san_pham where loaisp="phukien" limit 6';
	$exec= mysqli_query($connect, $sl);
	while($row= mysqli_fetch_array($exec)){
?>
	<div class="sp img-thumbnail col-xs-12 col-sm-6 col-md-6 col-lg-3">
