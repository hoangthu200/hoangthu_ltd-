...
public class MainActivity extends AppCompatActivity {
    ...
    private void anhXa() {
        ...
        arrayImage.add(new hinhAnh(R.drawable.anh,"Võ Thị Hoàng Thư",""));
        arrayImage.add(new hinhAnh(R.drawable.android_logo,"hinh 1",""));
        arrayImage.add(new hinhAnh(R.drawable.coffee,"hinh 2",""));
        arrayImage.add(new hinhAnh(R.drawable.facebook,"hinh 3",""));
        arrayImage.add(new hinhAnh(R.drawable.google,"hinh 4",""));
        arrayImage.add(new hinhAnh(R.drawable.android_background,"hinh 5",""));
    }
